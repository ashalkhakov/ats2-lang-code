...
/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 2289(line=76, offs=21) -- 2321(line=76, offs=53)
*/
ATSglobaldec()
ats_void_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__print_mpz (ats_ref_type arg0) {
/* local vardec */
// ATSlocal_void (tmp0) ;
...
__ats_lab_ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__print_mpz:
tmp1 = atspre_stdout_get () ;
tmp2 = ats_selsin_mac(tmp1, atslab_1) ;
/* tmp3 = */ atslib_fprint_mpz (tmp2, arg0) ;
/* tmp0 = */ atspre_stdout_view_set () ;
return /* (tmp0) */ ;
} /* end of [ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__print_mpz] */

/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 2342(line=77, offs=21) -- 2374(line=77, offs=53)
*/
ATSglobaldec()
ats_void_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__prerr_mpz (ats_ref_type arg0) {
/* local vardec */
// ATSlocal_void (tmp4) ;
...
__ats_lab_ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__prerr_mpz:
tmp5 = atspre_stderr_get () ;
tmp6 = ats_selsin_mac(tmp5, atslab_1) ;
/* tmp7 = */ atslib_fprint_mpz (tmp6, arg0) ;
/* tmp4 = */ atspre_stderr_view_set () ;
return /* (tmp4) */ ;
} /* end of [ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__prerr_mpz] */

/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 2399(line=79, offs=24) -- 2424(line=79, offs=49)
*/
ATSglobaldec()
ats_ptr_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__tostrptr_mpz (ats_ref_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp8) ;

__ats_lab_ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__tostrptr_mpz:
tmp8 = atslib_mpz_get_str (10, arg0) ;
return (tmp8) ;
} /* end of [ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__tostrptr_mpz] */

/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 2448(line=80, offs=24) -- 2519(line=82, offs=4)
*/
ATSglobaldec()
ats_ptr_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__tostring_mpz (ats_ref_type arg0) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp9) ;
ATSlocal (ats_ptr_type, tmp10) ;

__ats_lab_ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__tostring_mpz:
tmp10 = atslib_mpz_get_str (10, arg0) ;
tmp9 = ats_castfn_mac(ats_ptr_type, tmp10) ;
return (tmp9) ;
} /* end of [ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__tostring_mpz] */

/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 2587(line=87, offs=11) -- 2880(line=97, offs=4)
*/
ATSglobaldec()
ats_void_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_incby (ats_ref_type arg0, ats_ulint_type arg1, ats_ulint_type arg2) {
/* local vardec */
// ATSlocal_void (tmp11) ;
...
__ats_lab_ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_incby:
...
return /* (tmp11) */ ;
} /* end of [ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_incby] */

/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 2924(line=100, offs=11) -- 3217(line=110, offs=4)
*/
ATSglobaldec()
ats_void_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_decby (ats_ref_type arg0, ats_ulint_type arg1, ats_ulint_type arg2) {
/* local vardec */
// ATSlocal_void (tmp19) ;
...
__ats_lab_ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_decby:
...
return /* (tmp19) */ ;
} /* end of [ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_decby] */

/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 3284(line=115, offs=13) -- 3754(line=131, offs=4)
*/
ATSglobaldec()
ats_void_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_pow3_ui (ats_ref_type arg0, ats_ref_type arg1, ats_ulint_type arg2) {
/* local vardec */
// ATSlocal_void (tmp27) ;
...
__ats_lab_ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_pow3_ui:
...
return /* (tmp27) */ ;
} /* end of [ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_pow3_ui] */

/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 3802(line=133, offs=23) -- 4077(line=145, offs=4)
*/
ATSglobaldec()
ats_void_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_pow2_ui (ats_ref_type arg0, ats_ulint_type arg1) {
/* local vardec */
// ATSlocal_void (tmp37) ;
...
__ats_lab_ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_pow2_ui:
...
return /* (tmp37) */ ;
} /* end of [ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__mpq_pow2_ui] */

/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 4784(line=179, offs=21) -- 4816(line=179, offs=53)
*/
ATSglobaldec()
ats_void_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__print_mpq (ats_ref_type arg0) {
/* local vardec */
// ATSlocal_void (tmp43) ;
...
__ats_lab_ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__print_mpq:
tmp44 = atspre_stdout_get () ;
tmp45 = ats_selsin_mac(tmp44, atslab_1) ;
/* tmp46 = */ atslib_fprint_mpq (tmp45, arg0) ;
/* tmp43 = */ atspre_stdout_view_set () ;
return /* (tmp43) */ ;
} /* end of [ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__print_mpq] */

/*
// /home/hwxi/research/Anairiats/libc/DATS/gmp.dats: 4837(line=180, offs=21) -- 4869(line=180, offs=53)
*/
ATSglobaldec()
ats_void_type
ATS_2d0_2e2_2e10_2libc_2SATS_2gmp_2esats__prerr_mpq (ats_ref_type arg0) {
/* local vardec */
// ATSlocal_void (tmp47) ;
...
ats_void_type
ATS_2d0_2e2_2e10_2libc_2DATS_2gmp_2edats__staload () {
static int ATS_2d0_2e2_2e10_2libc_2DATS_2gmp_2edats__staload_flag = 0 ;
if (ATS_2d0_2e2_2e10_2libc_2DATS_2gmp_2edats__staload_flag) return ;
ATS_2d0_2e2_2e10_2libc_2DATS_2gmp_2edats__staload_flag = 1 ;
...
// extern ats_int_type ATS_2d0_2e2_2e10_2libc_2DATS_2gmp_2edats__dynload_flag ;

ats_void_type
ATS_2d0_2e2_2e10_2libc_2DATS_2gmp_2edats__dynload () {
// ATS_2d0_2e2_2e10_2libc_2DATS_2gmp_2edats__dynload_flag = 1 ;
ATS_2d0_2e2_2e10_2libc_2DATS_2gmp_2edats__staload () ;
